...
export class Snowflake {
  ...
  static #dataCenterIdShift: bigint = Snowflake.#sequenceBits + Snowflake.#workerIdBits;
  static #timestampLeftShift: bigint = Snowflake.#dataCenterIdShift + Snowflake.#dataCenterIdBits;
  ...
  constructor(workerId: bigint, dataCenterId: bigint) {
    if (workerId > Snowflake.#maxWorkerId || workerId < 0n)
      throw new Error(`workerId can't be greater than ${Snowflake.#maxWorkerId} or less than 0`);
